...
VALUES (3, NULL, '1962-01-17T00:00:00.0000000', N'Jim Carrey', NULL),
(4, NULL, '1965-04-04T00:00:00.0000000', N'Robert Downey Jr.', NULL),
(5, NULL, '1981-06-13T00:00:00.0000000', N'Chris Evans', NULL);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Biography', N'DateOfBirth', N'Name', N'Picture') AND [object_id] = OBJECT_ID(N'[People]'))
    SET IDENTITY_INSERT [People] OFF;
GO


IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'MovieId', N'PersonId', N'Character', N'Order') AND [object_id] = OBJECT_ID(N'[MoviesActors]'))
    SET IDENTITY_INSERT [MoviesActors] ON;
INSERT INTO [MoviesActors] ([MovieId], [PersonId], [Character], [Order])
VALUES (4, 3, N'Dr. Ivo Robotnik', 1),
(2, 4, N'Tony Stark', 1),
(3, 4, N'Tony Stark', 1),
(2, 5, N'Steve Rogers', 2),
(3, 5, N'Steve Rogers', 2);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'MovieId', N'PersonId', N'Character', N'Order') AND [object_id] = OBJECT_ID(N'[MoviesActors]'))
