...
namespace MoviesAPI.Services
{
    public class InAppStorageService : IFileStorageService
    {
        ...
        public async Task<string> EditFile(byte[] content, string extension, string containerName, 
            string fileRoute, string contentType)
        {
            ...
            string contentType)
        {
            ...
            var currentUrl = $"{httpContextAccessor.HttpContext.Request.Scheme}://" +
