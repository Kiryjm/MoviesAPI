...
namespace MoviesAPI
{
    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var jimCarrey = new Person() { Id = 3, Name = "Jim Carrey", DateOfBirth = new DateTime(1962, 01, 17) };
            var robertDowney = new Person() { Id = 4, Name = "Robert Downey Jr.", DateOfBirth = new DateTime(1965, 4, 4) };
            var chrisEvans = new Person() { Id = 5, Name = "Chris Evans", DateOfBirth = new DateTime(1981, 06, 13) };
